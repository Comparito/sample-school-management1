...
export interface IOrganizationDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>Are you sure you want to delete this Organization?</ModalBody>
        <ModalFooter>
