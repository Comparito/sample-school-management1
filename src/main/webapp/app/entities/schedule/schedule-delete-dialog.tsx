...
export interface IScheduleDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>Are you sure you want to delete this Schedule?</ModalBody>
        <ModalFooter>
